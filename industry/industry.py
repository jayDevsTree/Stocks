...
@router.post("/industry/create", status_code = status.HTTP_201_CREATED, response_model=industry_schema.industry_out)
...
@router.delete("/industry/{industry_id}",status_code = status.HTTP_204_NO_CONTENT)
...
@router.get("/industry", response_model = list[industry_schema.industry_out])
...
@router.get("/industry/{industry_id}",response_model = industry_schema.industry_out)
...
@router.put("/industry/{industry_id}",response_model = industry_schema.industry_out)
